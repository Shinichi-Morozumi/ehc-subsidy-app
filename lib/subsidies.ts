...
export const SUBSIDIES: Subsidy[] = [
  ...
  },
  {
    ...
    rate: "3/4〜2/3（CO2削減量・省エネ診断有無の区分による）",
    max: "最大4,500万円（28t-CO2以上削減で3/4）／2,500万円（診断受診2/3）／1,000万円（自己作成2/3）",
    target: ["ac", "multi"],
    biz: ["business"],
    size: ["sme"],
    pref: ["東京都"],
  ...
  },
  {
    ...
    scheduleNote: "令和8年度は交付申請 7/24 17時必着で締切間近。※R8対象は太陽光・蓄電池・再エネ発電・熱利用・コージェネ・EMS等で、業務用空調（エアコン）は補助対象外",
    name: "埼玉県 企業等における省エネ・再エネ活用設備導入補助金",
    org: "埼玉県",
    period: "令和8年度：交付申請 2026/7/6〜7/24 17時必着（予算8,983万円）",
    rate: "1/2〜2/3（設備区分による）",
    max: "上限1,500〜2,500万円（設備区分による。コージェネ2,500万円等）",
    target: ["ac", "multi"],
    biz: ["business"],
    size: ["sme"],
    pref: ["埼玉県"],
