      ...
      <header className="relative overflow-hidden rounded-3xl mb-5 no-print bg-night-900 border border-white/10">
        ...
        <div className="relative px-6 py-10 md:px-12 md:py-14">
          <div className="flex items-center gap-2 mb-5">
            ...
            <span className="text-[11px] tracking-[0.18em] text-slate-300 font-medium">EHC SOLUTIONS</span>
          </div>
          ...
          <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-[11px] text-slate-400">
